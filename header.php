...
<body <?php body_class( get_post()->post_name ); ?> id="body-<?php echo get_post()->post_name; ?>" >
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/de_DE/sdk.js#xfbml=1&version=v2.8&appId=260077571117435";
